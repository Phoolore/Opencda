...
class ScenarioManager:
    ...
    def create_vehicle_manager(self, application, map_helper=None, data_dump=False, fallback_model: str = "vehicle.lincoln.mkz_2017", semantic_tag_list = 0):
        """
        ...
        for i, cav_config in enumerate(self.scenario_params["scenario"]["single_cav_list"]):
            ...
            vehicle_manager = VehicleManager(
                ...
                prefix="cav", semantic_tag_list=[semantic_tag_list],
            )
